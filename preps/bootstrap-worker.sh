...
HOSTNAME_FQDN="k8s-worker"
IP_ADDR="192.168.85.210/24"   # keep your test subnet here
GW_ADDR="192.168.85.2"        # adjust as needed
DNS_ADDR="192.168.85.2 1.1.1.1 8.8.8.8"
...
set_static_ip_nmcli() {
  ...
  # IMPORTANT FIX: one modify call including the address
